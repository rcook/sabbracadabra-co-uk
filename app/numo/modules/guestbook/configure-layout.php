...
<ul class="breadcrumb">
  ...
  <li class="active">Configure Layout</li>
</ul>
...
<br/>
<input type="submit" name="cmd" class='btn btn-large btn-success' value="Save" />
<input type="submit" name="cmd" class='btn btn-large' value="Cancel" />
</form>