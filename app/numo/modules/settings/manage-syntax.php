...
.ui-widget-content { border: 0px solid #ccc; background: #fff; color: #333333; }
.ui-widget-content a { color: #333333; }
.ui-widget-header { border: 0px solid #2A61B3; background: #ffffff repeat-x; color: #ffffff; font-weight: bold; border-bottom: 1px solid #cccccc;}
