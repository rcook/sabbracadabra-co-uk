...
<?php	
	...
	if($row = mysql_fetch_array($result)) {
		print '<table class="table table-bordered" style="width: 400px;"><tr><td><label for="stock">Stock:</label></td><td><input class="stock_amount" type="text" name="stock__'.$_GET['id'].'" id="stock" value="'.$row['units'].'" />&nbsp;units</td></tr></table>';
?>
<input type="hidden" name="cmd" value="update" />
<input type="submit" name="nocmd"  class='btn btn-success' value="Update" />
<input type="submit" name="nocmd"  class='btn btn-warning' value="Disable Stock on this Item" />
