...
if(mysql_num_rows($results) > 0) {
	echo '<table class="table table-striped"><tr><th style="width: 20px">&nbsp;</th><th class="highlight_label">'.$slots[1]['name'].'</th><th style="width: 60px; text-align:center">'.$slots[2]['name'].'</th><th>&nbsp</th></tr>';
