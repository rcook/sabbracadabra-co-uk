...
<form method="post">
	...
	<ul class="form_display">
		...
		?>
		<li><label for="submit_cmd"></label><input type="submit" id="submit_cmd" name="nocmd" value="Create" /></li>
	</ul>
	</fieldset>
...
<form method="post">
	...
	<ul class="form_display">
		<li><label for="type_id">Account Group:</label><select id="type_id" name="type_id"><?=list_account_group_options()?></select></li>
		<li><label for="submit_cmd"></label><input type="submit" id="submit_cmd" name="nocmd" value="Next" /></li>
	</ul>
	</fieldset>
</form>
<?php
