...
//***************************************************************************
if(isset($_SESSION['account_id']) && $PARAMS['always_show'] != "1") {
...
//***************************************************************************
?>
<link rel="stylesheet" type="text/css" href="//<?php print NUMO_SERVER_ADDRESS?><?php print NUMO_FOLDER_PATH; ?>modules/accounts/components/styles/registration_box.css" />
<?php if ($PARAMS['title'] != "") {?>
...
if($_POST['cmd'] == "create" && $_POST['demo'] == "") {
