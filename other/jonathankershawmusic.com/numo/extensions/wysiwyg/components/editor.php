...
<?php } ?>
	...
	<textarea id="<?php echo $PARAMS['wysiwyg_id']; ?>" name="<?php echo $PARAMS['wysiwyg_name']; ?>" rows="15" cols="80" style="width: <?php echo $PARAMS['wysiwyg_width']; ?>"><?php echo htmlentities($PARAMS['wysiwyg_content']); ?></textarea>
<?php if ($PARAMS['wysiwyg_wrap_with_form_tag']) { ?>
	<br />
