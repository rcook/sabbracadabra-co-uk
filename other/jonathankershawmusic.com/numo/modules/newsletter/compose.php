...
?>
	...
	<table id="compose_display_window" class='table table-bordered'>
	<tr>
...
<?php
    ...
    <input type='submit' class='btn btn-large btn-success' name="save_button" value="Save" />
    <!--
	<input type="image" name="save_button" src="modules/newsletter/images/compose_save_button.jpg" value="Save" />-->
	<a class='btn btn-large' href="module/<?=$_GET['m']?>/manage/">Cancel</a>
	</td></tr></table>
	</form>
