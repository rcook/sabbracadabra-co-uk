...
<h2>Subscription Lists</h2>
	...
	?>
		<li><input style='margin: 0px !important;' type="checkbox" name="lists[]" checked="checked" id="list_<?=$row['id']?>" value="<?=$row['id']?>" /><label style='margin: 0px 0px 0px 10px; width: auto; float: none; display: inline-block;'for="list_<?=$row['id']?>"><?=$row['name']?></label></li>
	<?php
		}	else {
	?>
		<li><input style='margin: 0px !important;'type="checkbox" name="lists[]" id="list_<?=$row['id']?>" value="<?=$row['id']?>" /><label style='margin: 0px 0px 0px 10px; width: auto; float: none; display: inline-block;' for="list_<?=$row['id']?>"><?=$row['name']?></label></li>
	<?php
		}
	...
	<input type="submit" name="nocmd" id="submit_input" class='btn btn-primary btn-large' value="Save" />
