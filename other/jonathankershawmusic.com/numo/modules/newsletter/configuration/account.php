...
<table class="table table-striped"><tr><th class="highlight_label">List Name</th><th>Subscribes</th></tr>
<?php
...
<br />
<a class='btn pull-right' href="module/newsletter/edit-subscriber/?id=<?=$_GET['id']?>">Manage Subscriptions</a>
<?php
}	else {
