...
<style>
.numo_guestbook_container {background: #FFFFFF; color: #222222; padding: 0px; margin: 2px 0px; border: 1px solid #999; width: 100%;}
.numo_guestbook_container td, .numo_guestbook_container th {vertical-align: top; text-align: left; padding: 2px; font-size: 9pt;}
.numo_guestbook_container th {border-bottom: 1px solid #999; padding: 1px 5px; font-size: 9pt;}
.numo_guestbook_container td table th {white-space:nowrap;}
...
.numo_guestbook_field_label {font-weight: bold;}
...
form.numo_form_display ul li {padding: 0px; margin: 0px; margin: 5px 0px; padding: 5px;}
...
form.numo_form_display ul li input.numo_text_input {width: 400px; padding: 5px;}
form.numo_form_display ul li select {margin: 0px;}
form.numo_form_display ul li label {vertical-align: top; padding: 5px 0px; display: block; font-size: 0.9em; font-weight: bold;}
