...
<form method="post" enctype="multipart/form-data">
	...
	<input type="submit" name="nocmd" id="submit_input"  class='btn btn-primary' value="Continue" />
     <a href="module/shopping_cart/manage-products/" class='btn btn-large'>Cancel</a>
	</fieldset>
...
<form method="post">
	...
	<div style="clear: both;"><br /></div>
	<input type="submit" name="nocmd" id="submit_input" class='btn btn-success btn-large' value="Import" />
     <a href="module/shopping_cart/manage-products/" class='btn btn-large'>Cancel</a>
	</fieldset>
