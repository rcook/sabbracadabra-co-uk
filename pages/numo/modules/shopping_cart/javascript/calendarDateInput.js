...
var CellWidth = 18;
var CellHeight = 16;
var ImageURL = '/numo/modules/shopping_cart/images/calendar.jpg';
var NextURL = '/numo/modules/shopping_cart/images/next.gif';
var PrevURL = '/numo/modules/shopping_cart/images/prev.gif';
...
with (document) {
   writeln('<style>');
   writeln('td.calendarDateInput {letter-spacing:normal;line-height:normal;font-family:' + FontFamily + ',Sans-Serif;font-size:' + FontSize + 'px; color: #000000;}');
...
function DateInput(DateName, Required, DateFormat, DefaultDate) {
   if (arguments.length == 0) document.writeln('<span style="color:red;font-size:' + FontSize + 'px;font-family:' + FontFamily + ';">ERROR: Missing required parameter in call to \'DateInput\': [name of hidden date field].</span>');
      ...
      with (document) {
         ...
         writeln('<table width="' + (CellWidth * 7) + 'px" cellspacing="0" cellpadding="1">' + String.fromCharCode(13) + '<tr style="background-color:' + TopRowBGColor + ';">');
         ...
         for (var w=0;w<7;w++) writeln('<td width="' + CellWidth + 'px" align="center" class="calendarDateInput" style="height:' + CellHeight + 'px;width:' + CellWidth + 'px;font-weight:bold;border-top:1px solid dimgray;border-bottom:1px solid dimgray;">' + WeekDays[w] + '</td>');
