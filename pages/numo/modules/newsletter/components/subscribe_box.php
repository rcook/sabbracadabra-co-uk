<style>
#numo_newsletter_subscription_component {border: 1px solid #666;}
...
#numo_newsletter_subscription_component form ul li label {width: 100px; display: inline-block; color: #000;}
