<style>
.subscribe-box-right { clear: right; float: right; width: 34%; margin-right: -20px; }
.subscribe-box-right h3 { color: #ffffff; font-size: 14pt;}
#numo_newsletter_subscription_component {border: 0px solid #666;}
#numo_newsletter_subscription_component form { margin: 0px; padding: 0px; margin-left: 10px;}
...
?>
<div class="whatsnew subscribe-box-right">
