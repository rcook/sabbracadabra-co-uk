...
this.each(function(c,b){if($type(c)=="function"){c.run(a);}});}});(function(){var b=["À","à","Á","á","Â","â","Ã","ã","Ä","ä","Å","å","?","?","?","?","?","?","?","?","Ç","ç","?","?","?","?","È","è","É","é","Ê","ê","Ë","ë","?","?","?","?","?","?","Ì","ì","Í","í","Î","î","Ï","ï","?","?","?","?","?","?","Ñ","ñ","?","?","?","?","Ò","ò","Ó","ó","Ô","ô","Õ","õ","Ö","ö","Ø","ø","?","?","?","?","?","Š","š","?","?","?","?","?","?","?","?","?","?","Ù","ù","Ú","ú","Û","û","Ü","ü","?","?","Ÿ","ÿ","ý","Ý","Ž","ž","?","?","?","?","Þ","þ","Ð","ð","ß","Œ","œ","Æ","æ","µ"];
...
},onHide:function(){this.tip.setStyle("display","none");},title:"title",text:function(b){ if (b.get("rel")) { return b.get("rel").replace(/\[b\]/gi, '<b>').replace(/\[\/b\]/gi, '</b>').replace(/\[br\/\]/gi, '<br/>')||b.get("href");} else { return ""; }},showDelay:100,hideDelay:100,className:"tip-wrap",offset:{x:16,y:16},windowPadding:{x:0,y:0},fixed:false},initialize:function(){var b=Array.link(arguments,{options:Object.type,elements:$defined});
